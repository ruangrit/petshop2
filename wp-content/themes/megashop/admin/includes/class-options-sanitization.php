...
/**
 * Sanitization for preset input
 *
 * Validates that the selected option is a valid option.
 */
add_filter( 'of_sanitize_preset', 'of_sanitize_enum', 10, 2 );
 ...
 * @return $output sanitized string
 */
function of_sanitize_number( $input ) {
    $output = intval($input);
	return $output;
}
add_filter( 'of_sanitize_number', 'of_sanitize_number' );
...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => esc_html__( 'No Repeat', 'megashop' ),
		'repeat-x'  => esc_html__( 'Repeat Horizontally', 'megashop' ),
		'repeat-y'  => esc_html__( 'Repeat Vertically', 'megashop' ),
		'repeat'    => esc_html__( 'Repeat All', 'megashop' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => esc_html__( 'Top Left', 'megashop' ),
		'top center'    => esc_html__( 'Top Center', 'megashop' ),
		'top right'     => esc_html__( 'Top Right', 'megashop' ),
		'center left'   => esc_html__( 'Middle Left', 'megashop' ),
		'center center' => esc_html__( 'Middle Center', 'megashop' ),
		'center right'  => esc_html__( 'Middle Right', 'megashop' ),
		'bottom left'   => esc_html__( 'Bottom Left', 'megashop' ),
		'bottom center' => esc_html__( 'Bottom Center', 'megashop' ),
		'bottom right'  => esc_html__( 'Bottom Right', 'megashop')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => esc_html__( 'Scroll Normally', 'megashop' ),
		'fixed'  => esc_html__( 'Fixed in Place', 'megashop')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => esc_html__( 'Normal', 'megashop' ),
		'italic'      => esc_html__( 'Italic', 'megashop' ),
		'bold'        => esc_html__( 'Bold', 'megashop' ),
		'bold italic' => esc_html__( 'Bold Italic', 'megashop' )
		);
